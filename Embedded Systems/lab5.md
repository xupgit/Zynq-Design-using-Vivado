...
Look at the *XScuTimer_LookupConfig( )* and *XScuTimer_CfgInitialize( )* API functions which must be called before the timer functionality can be accessed.
  ...
  <p align="center">
  <img src ="/Embedded Systems/pics/lab 5/1usefulfn.jpg " width="70%" height="80%"/>
  </p>
  <p align="center">
  <img src ="/Embedded Systems/pics/lab 5/2usefulfn.jpg " width="70%" height="80%"/>
  </p>
  <p align = "center">
...
1.	In SDK, in the **Problems** tab, double-click on the unknown type name x for the parse error. This will open the source file and bring you around to the error place.  
    ...
    <p align="center">
    <img src ="/Embedded Systems/pics/lab 5/3fsterr.jpg " width="80%" height="80%"/>
    </p>
    <p align = "center">
    <i>First error</i>
    </p>
...
3.	Scroll down the file and notice that there are few lines intentionally left blank with some guiding comments.
     ...
     <p align="center">
     <img src ="/Embedded Systems/pics/lab 5/4fillin.jpg " width="80%" height="80%"/>
     </p>
     <p align = "center">
...
5. Scroll down the file further and notice that there are few more lines intentionally left blank with some guiding comments.
   ...
   <p align="center">
   <img src ="/Embedded Systems/pics/lab 5/5morecd.jpg " width="80%"  height="80%"/>
   </p>
   <p align = "center">
...
3.	Select lab5 in Project Explorer, right-click and select **Run As > Launch on Hardware (System Debugger)** to download the application, execute *ps7_init*, and execute *lab5.elf*
    ...
    <p align="center">
    <img src ="/Embedded Systems/pics/lab 5/7termop.jpg " width="30%"  height="80%"/>
    </p>
    <p align = "center">
...
3.	Double-click in the left margin to set a breakpoint on various lines in *lab5.c* shown below. A breakpoint has been set when a “tick” and blue circle appear in the left margin beside the line when the breakpoint was set. (The line numbers may be slightly different in your file.)
    ...
    <p align="center">
    <img src ="/Embedded Systems/pics/lab 5/8bp.jpg " width="80%"  height="80%"/>
    </p>
    <p align="center">
    <img src ="/Embedded Systems/pics/lab 5/9bp.jpg " width="80%"  height="80%"/>
    </p>
    <p align = "center">
    <i>Setting breakpoints</i>
    </p>

4.	Click on the **Resume** (![Resume](/Embedded Systems/pics/lab 5/aresume.jpg) ) button to continue executing the program up until the first breakpoint is reached.
In the _Variables_ tab you will notice that the count variable may have value other than 0.
5.	Click on the **Step Over** (![Stepover](/Embedded Systems/pics/lab 5/bstepover.jpg)) button or press F6 to execute one statement. As you do step over, you will notice that the count variable value changed to 0.
...
9.	Click the plus sign to add a **Memory Monitor**
    ...
    <p align="center">
    <img src ="/Embedded Systems/pics/lab 5/cmemlocn.jpg " width="30%"  height="80%"/>
    </p>
    <p align = "center">
...
10.	Enter the address for the private counter load register (_0xF8F00600_), and click OK.
    ...
    <p align="center">
    <img src ="/Embedded Systems/pics/lab 5/dmonitormem.jpg " width="30%"  height="80%"/>
    </p>
    <p align = "center">
