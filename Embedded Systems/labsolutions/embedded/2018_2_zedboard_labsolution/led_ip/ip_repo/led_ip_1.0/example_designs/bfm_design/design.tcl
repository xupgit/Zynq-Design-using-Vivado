proc create_ipi_design { offsetfile design_name } {
	...
	set led_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:XUP:led_ip:1.0 led_ip_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:XUP:led_ip:1.0]]]]
